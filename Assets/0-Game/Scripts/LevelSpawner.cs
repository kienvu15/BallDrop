...
public class LevelSpawner : MonoBehaviour
{
    ...
    void Awake()
    {
        plateMat.color = Random.ColorHSV(0f, 1f, 0.5f, 1f, 0.5f, 1f);
        ...
        for(i = 0; i > -level - addOn; i -= 0.5f)
        {
            ...
            temp1.transform.parent = FindFirstObjectByType<Rotator>().transform;
        }

        temp2 = Instantiate(winPrefab);
        temp2.transform.position = new Vector3(0, i - 0.5f, 0);
    }
